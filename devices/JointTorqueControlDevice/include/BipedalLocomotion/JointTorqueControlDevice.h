...
private:
    ...
    yarp::sig::Vector estimatedCurrentResiduals;
    yarp::sig::Vector measuredMotorCurrents;
    ...
    bool loadCurrentResidualParams(std::weak_ptr<const ParametersHandler::IParametersHandler> paramHandler);
